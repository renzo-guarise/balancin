...
#define MPU6050REGISTERS_H_
	...
	//The accelerometer and gyroscope are filtered according to the value of DLPF_CFG bits on CONFIG register.
	typedef enum{
	...
	typedef enum{
		...
		EXT_SYNC_DISABLED,       
		EXT_SYNC_TEMP_OUT_L,     
		EXT_SYNC_GYRO_XOUT_L,   
		EXT_SYNC_GYRO_YOUT_L,   
		EXT_SYNC_GYRO_ZOUT_L,    
		EXT_SYNC_ACCEL_XOUT_L,  
		EXT_SYNC_ACCEL_YOUT_L,  
		EXT_SYNC_ACCEL_ZOUT_L, 
	...
	typedef struct{
		...
		bool ACONFIG_XA_ST_BIT;
		bool ACONFIG_YA_ST_BIT;
		bool ACONFIG_ZA_ST_BIT;
	
		}ACCEL_ST;

	typedef struct{
	
		bool GCONFIG_XG_ST_BIT;
		bool GCONFIG_YG_ST_BIT;
		bool GCONFIG_ZG_ST_BIT;
	...
	typedef struct{
		...
		uint8_t		 smplrt_div;
		DLPF		 Filtro;
		EXT_SYNC_SET EXT_SYN;
		GYRO_FS		 GYRO_SCALE;
		ACCEL_FS	 ACCEL_SCALE;
		CLOCKSOURCE	 CLSOURCE;
